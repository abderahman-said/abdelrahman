                ...
                <div className="nav-left" style={{ cursor: "url('/assets/Cursor SVG/cursor-pointer.svg') 12 12, pointer" }}>
                    <div className="nav-hover-trigger">
                        <div className="logo-work-container">
                            ...
                            <span className="logo-work-text">abdo</span>
                        </div>
                            ...
                            <div className="nav-popout-inner">
                                <div className="nav-work-item">
                                    <div className="nav-work-item__text">
                                        <span className="nav-work-badge badge-blue">Puiux</span>
                                        <h4 className="nav-work-title">React Developer</h4>
                                    </div>
                                </div>
                                <div className="nav-work-item">
                                    <div className="nav-work-item__text">
                                        <span className="nav-work-badge badge-green">Deltawy</span>
                                        <h4 className="nav-work-title">React Developer (Part-time)</h4>
                                    </div>
                                </div>
                                <div className="nav-work-item">
                                    <div className="nav-work-item__text">
                                        <span className="nav-work-badge badge-purple">Awny</span>
                                        <h4 className="nav-work-title">React Developer (Part-time)</h4>
                                    </div>
                                </div>
                                <div className="nav-work-item">
                                    <div className="nav-work-item__text">
                                        <span className="nav-work-badge badge-orange">A-plus</span>
                                        <h4 className="nav-work-title">React Developer</h4>
                                    </div>
                                </div>
                                <a href="https://drive.google.com/file/d/18jOmSRCVYzUiLHsTNPR0gRhBLSzcV0qE/view" className="nav-work-btn"><span className="nav-work-btn__text">View Full Resume</span></a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="nav-right" style={{ cursor: "url('/assets/Cursor SVG/cursor-pointer.svg') 12 12, pointer" }}>
                    <div className="nav-hover-trigger">
                        ...
                        <div className="nav-popout nav-wa-box">
                            <div className="nav-popout-inner">
                                <h4 className="nav-wa-title">whatsapp me</h4>
                                <p className="nav-wa-desc">Click below to chat with me directly on WhatsApp</p>
                                <a href="https://wa.me/201552323225" target="_blank" rel="noopener noreferrer" className="nav-wa-link">
                                    <span className="nav-wa-link-text">Chat now</span>
