        ...
        <div className="footer-inner">
            <div className="footer-top">
                ...
                <div className="footer-column">
                    ...
                    <a href="https://www.google.com/maps/place/Mansoura,+Egypt" target="_blank" rel="noopener noreferrer" className="footer-map-link">
                ...
                <div className="footer-column">
                    ...
                    <a href="mailto:abdorady6500@gmail.com" className="footer-email">abdorady6500@gmail.com</a>
                    <a href="https://wa.me/201552323225" target="_blank" rel="noopener noreferrer" className="footer-whatsapp">send me a whatsapp*</a>
                    <p className="footer-note">*feel free to message me anytime!</p>
                        ...
                        <div className="credits-box">
                            <div className="credits-content">
                                <div className="credits-item credit-wiggle">
                                    ...
                                    <div className="overflow-wrapper"><a href="#" className="credits-name" data-wiggle-target="true">Abdelrahman</a></div>
                                </div>
                            </div>
                        </div>
